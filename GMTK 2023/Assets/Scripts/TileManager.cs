...
public class TileManager : MonoBehaviour
{
    ...
    public void movePieceTile(int x, int z, bool isWhite, int pieceNumber, bool oldTileColourBlack)
    {
        Color colour;
        if (oldTileColourBlack)
        {
            colour = defaultColorBlack;
        }
        else
        {
            colour = defaultColorWhite;
        }
        ...
        {
            board[allEnemies[pieceNumber].enemyPos[0], allEnemies[pieceNumber].enemyPos[1]].GetComponent<Renderer>().material.color = colour;
    ...
    public void movePlayer(int[] pos)
    {
        ...
        playerPieceObject.GetComponent<PieceAttributes>().GoTo(playerPosition[0],playerPosition[1]);
        updateBoard();
    }
